...
const HOW = [
  ...
  { k: '🍛', v: 'FULKI. HEALS +8 AND RAISES MAX HP BY 4. FOOD IS PROGRESSION.' },
  { k: '🍔', v: 'ONE BURGER PER RUN, PRE-BOSS, GOLDEN. IT IS AN EXTRA LIFE. TAKE IT.' },
...
const BOSS = [
  ...
  { k: '☠ LECTURE', v: 'FLOODS THE FLOOR. ONLY HURTS ON THE GROUND — JUMP IT. FULL COUNTDOWN WARNING.' },
  { k: '🗡 THE STICK', v: 'HE STOPS FLOATING, TURNS INTO A STICK FIGURE AND WALKS OVER TO HIT YOU PERSONALLY. GET IN THE AIR.' },
  { k: '⚡ HIS LASER', v: 'STAGE 2 ONLY. LOCKS ONTO YOUR HEIGHT, DASHED LINE WARNS YOU, THEN FIRES. MOVE.' },
];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <section className="mt-10 border-2 border-hot/50 p-5 md:p-7">
          ...
          <p className="font-pixel text-[8px] text-neon/45 leading-[2] mb-6">
            ...
            <br />
            <br />
            <span className="text-hot">HE HAS TWO STAGES.</span> TAKE HIS EGO TO ZERO AND HE DOES
            NOT LEAVE — HE COMES BACK ANGRIER, BIGGER, FASTER, AND WITH A LASER OF HIS OWN.
            <br />
            <br />
            NOTHING KILLS IN ONE HIT. YOU HAVE 100 HP AND FULKI RAISES THE CEILING.
            IF HE PUTS YOU DOWN AND YOU STILL HAVE THE BURGER, YOU GET BACK UP.
          </p>
