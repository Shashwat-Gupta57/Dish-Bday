 ...
 *
 * Split into its own module so the bundler emits it as a separate chunk that is
 * only fetched once the key checks out — none of this text exists in the file a
 * casual visitor downloads.
 */
